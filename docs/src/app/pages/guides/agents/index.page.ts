...
@Component({
  selector: 'app-guides-agents',
  imports: [RouterLink],
  template: `
    <h1>AI Agent Instructions</h1>
    <p class="subtitle">Context and guidelines for AI agents helping with this project.</p>

    <div class="doc-list">
      @for (doc of docs; track doc.slug) {
        <a [routerLink]="['/guides/agents', doc.slug]" class="doc-item">
...
export default class AgentsIndexPage {
  readonly docs = injectContentFiles<DocAttributes>((file) =>
    file.filename.includes('/agents/')
