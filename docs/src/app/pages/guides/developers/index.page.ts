...
@Component({
  selector: 'app-guides-developers',
  imports: [RouterLink],
  template: `
    <h1>Developer Guide</h1>
    <p class="subtitle">Technical documentation for contributors and developers.</p>

    <div class="doc-list">
      @for (doc of docs; track doc.slug) {
        <a [routerLink]="['/guides/developers', doc.slug]" class="doc-item">
...
export default class DevelopersIndexPage {
  readonly docs = injectContentFiles<DocAttributes>((file) =>
    file.filename.includes('/developers/')
